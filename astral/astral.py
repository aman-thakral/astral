...
_CITY_INFO = """
Abu Dhabi,UAE,24Â°28'N,54Â°22'E,Asia/Dubai
...
London,England,51Â°36'N,00Â°05'W,Europe/London
...
Stockholm,Sweden,59Â°20'N,18Â°03'E,Europe/Stockholm
...
class Astral(object):
    ...
    def _julianday(self, day, month, year):
        return lib._julianday(day,month,year)
    ...
    def _eq_of_time(self, juliancentury):
        return lib._eq_of_time(juliancentury)

    def _sun_eq_of_center(self, juliancentury):
        return lib._sun_eq_of_center(juliancentury)
    ...
    def _sun_declination(self, juliancentury):
        return lib._sun_declination(juliancentury)

    def _hour_angle(self, latitude, solar_dec, solar_depression):
        return lib._hour_angle(latitude, solar_dec, solar_depression)
